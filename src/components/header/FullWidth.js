...
const FullWidth =({fullWidth,toggleFullWidth})=>{
    ...
    return <button title='fullWidth' onClick={toggleFullWidth} data-umami-event='切换宽度' className=' p-2 xl:inline-block hover:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer rounded-lg '>
        {fullWidth ? (
