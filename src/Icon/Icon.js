  ...
  export const SunToMoon= ({ className }) => {  return (
    <svg xmlns="http://www.w3.org/2000/svg"   viewBox="0 0 24 24" className={className}   >
      ...
      <g  fillOpacity="0"  fill="currentcolor">
  ...
  export const MoonToSun= ({ className }) => {    return (
    ...
    <g  fill="currentcolor" stroke="currentcolor" strokeDasharray="2" strokeDashoffset="2" strokeLinecap="round" strokeWidth="2">
    <path d="M0 0">
    ...
    </g><g fill="currentcolor" stroke="currentcolor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
  ...
  export const WordIcon= ({ className }) => {return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 56 56" strokeWidth="2" stroke="currentColor" className={className}>
  ...
  export const LoginIcon= ({ className }) => {return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" strokeWidth="1.2" stroke="currentColor" className={className}>
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5v2a1 1 0 0 1-1 1h-2m0-13h2a1 1 0 0 1 1 1v2m-13 0v-2a1 1 0 0 1 1-1h2m0 13h-2a1 1 0 0 1-1-1v-2m6.5-4a2 2 0 1 0 0-4a2 2 0 0 0 0 4m3.803 4.5a3.994 3.994 0 0 0-7.606 0z"/>
</svg>
)}
export const FriendsIcon= ({ className }) => {return (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" strokeWidth="0.1" stroke="currentColor" className={className}>
...
export const PicIcon= ({ className }) => {return (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" strokeWidth="0.1" stroke="currentColor" className={className}>
      <g fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="4">
        <path strokeLinecap="round" d="M5 10a2 2 0 0 1 2-2h34a2 2 0 0 1 2 2v28a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V10Z" clipRule="evenodd"/>
        <path strokeLinecap="round" d="M14.5 18a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3Z" clipRule="evenodd"/>
...
<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 56 56" fill="none" strokeWidth="1" stroke="currentColor" className={className}>
...
export const Pic1Icon= ({ className }) => {return (
  <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none" strokeWidth="1" stroke="currentColor" className={className}>
...
export const VipIcon= ({ className }) => {return (
  <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none" strokeWidth="0.5" stroke="currentColor" className={className}>
...
export const BlogIcon= ({ className }) => {return (
  <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 22.5 22.5" fill="none" strokeWidth="2.5" stroke="currentColor" className={className}>
