export const lang = {
  zh: {
    ...
    CONTACT: {
      ...
      TG_DESCRIPTION: '会直接发送到我的Telegram! ',
    ...
    FOOTER: {
      COPYRIGHT_START: '本站所有资源收集整理于网络,本站不参与制作,用于互联网爱好者学习和研究,如不慎侵犯了您的权利,请及时联系站长处理删除。敬请谅解！ ',
  ...
  en: {
    ...
    CONTACT: {
      ...
      TG_DESCRIPTION: 'Will send me via Telegram! ',
