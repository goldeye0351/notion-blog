    ...
    >
      <footer className='max-w-screen-2xl px-4 md:px-8 mx-auto'>
        ...
        <div className='text-sm flex justify-between'>
            <div className="flex items-center space-x-1">
              ...
              <div className="flex space-x-1.5 hover:animate-bounce  ">
               <Link href="https://github.com/goldeye0351/notion-blog">
                 <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className=' fill-black dark:fill-white w-6 h-6 hover:w-8 hover:h-8 '>
              ...
              <div className="flex space-x-1.5 hover:animate-bounce  ">
               <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 76 65' className=' fill-black dark:fill-white w-5 h-5 hover:w-8 hover:h-8 '>
                <path fill="currentColor" d="M37.5274 0L75.0548 65H0L37.5274 0Z"/></svg>
              </div>

              <div className="flex space-x-1.5 hover:animate-bounce  ">
                <svg viewBox="0 0 35 21" xmlns="http://www.w3.org/2000/svg" className=' w-8 h-6 hover:w-10 hover:h-8'>
                  <path 
              ...
              <div className="flex space-x-1.5 hover:animate-bounce  " >
              <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className=' fill-black dark:fill-white w-6 h-6 hover:w-8 hover:h-8 '>
            ...
            <div className='float-right my-1 flex space-x-2  '>
