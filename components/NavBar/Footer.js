      ...
      <footer className='max-w-screen-2xl  mx-auto'>
        ...
        <div className='flex justify-between h-16 '>
            <Link href="https://github.com/goldeye0351/notion-blog" className="flex items-center space-x-3">
              ...
              <div className="flex space-x-1.5  hover:text-sky-400     ">
              ...
              <div className="flex space-x-1.5 hover:text-sky-400    ">
               <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 76 65' className='duration-500  fill-black dark:fill-white w-5 h-5  '>
                <path fill="currentColor" d="M37.5274 0L75.0548 65H0L37.5274 0Z"/></svg>
              </div>

              <div className="flex space-x-1.5    ">
                <svg viewBox="0 0 35 21" xmlns="http://www.w3.org/2000/svg" className='duration-500  w-8 h-6 '>
                  <path 
