    ...
    >
      <footer className='max-w-screen-2xl  mx-auto'>
        ...
        <div className='flex justify-between h-16 '>
            <Link href="https://github.com/goldeye0351/notion-blog" className="flex items-center space-x-3">
            

              <div className="flex space-x-1.5 hover:animate-bounce duration-500  ">
                 <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='duration-500  fill-black dark:fill-white w-6 h-6 hover:w-8 hover:h-8 '>
                  <path fill="currentColor"  d='M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22'></path>
                 </svg>  
              </div>

              <div className="flex space-x-1.5 hover:animate-bounce duration-500  ">
               <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 76 65' className='duration-500  fill-black dark:fill-white w-5 h-5 hover:w-10 hover:h-10 '>
                <path fill="currentColor" d="M37.5274 0L75.0548 65H0L37.5274 0Z"/></svg>
              </div>

              <div className="flex space-x-1.5 hover:animate-bounce duration-500   ">
                <svg viewBox="0 0 35 21" xmlns="http://www.w3.org/2000/svg" className='duration-500  w-8 h-6 hover:w-12 hover:h-10'>
                  <path 
