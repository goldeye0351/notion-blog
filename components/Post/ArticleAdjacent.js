...
const Prevandnext = ( {prev, next, me } ) => {
  ...
  <div className=' justify-center mx-auto  py-5 relative flex  h-96 opacity-70  '>
  <div className=" absolute -bottom-16  w-screen rounded-t-full flex flex-grow overflow-hidden ">
    
    
      <div className="md:w-2/5 md:h-96 w-3/5 h-36 scale-110 duration-500 overflow-hidden hover:w-4/5 relative" >
      ...
      <div className="md:w-1/5 md:h-96 w-0 h-36 -skew-x-12 scale-110  relative   z-10    duration-500 overflow-hidden hover:w-2/5" >
