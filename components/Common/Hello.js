...
function Hello({title,txt,logoimg}) {
    ...
    <div id="form-wrap" className=" group relative  ">
      ...
      <div className="absolute  -z-20 mt-52  group-hover:mt-0 duration-1000 h-36 w-full flex mx-auto flex-row justify-center items-center content-center ">
          <div className='flex mx-auto flex-row justify-center items-center content-center'>
            {logoimg}
          </div>
      </div>
      <div className="absolute  -z-20 mt-72  group-hover:mt-32 duration-1000   ">
      ...
      {/* 前面的图片 */}
      <div className="absolute  -z-30 mt-24 ">
