...
<div title={BLOG.about} description={BLOG.description} className='about'>
  <div className="flex justify-center ">
     <Tilt 
              className="my3d shadow-2xl shadow-gray-500 rounded-xl  bg-slate-200 dark:bg-slate-600 max-w-3xl 
            ...
            >
              ...
              <div className="my3din flex flex-col justify-center items-center flex-wrap p-8">
